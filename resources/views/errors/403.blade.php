@component('layouts.app')
    <div class="flex flex-col items-center justify-center min-h-[80vh] text-center px-4">
        <h1 class="text-9xl font-black text-red-200">403</h1>
        <h2 class="text-3xl font-bold text-gray-800 mt-4">{{ __('messages.403_title') }}</h2>
        <p class="text-gray-500 mt-2 mb-8">{{ __('messages.403_description') }}</p>
