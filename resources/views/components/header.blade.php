        ...
        <div x-data="{ open: false }" @click.outside="open = false" class="relative pl-1">
            <button @click="open = !open" 
                ...
                <div class="relative w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-gradient-to-tr from-primary to-indigo-500 p-[2px] shadow-sm group-hover:shadow-md transition-shadow">
                    <div class="w-full h-full rounded-full bg-white dark:bg-[#0f172a] flex items-center justify-center">
            ...
            <div x-show="open" 
                ...
                <div class="px-2">
                    <a href="#" class="group flex items-center gap-3 px-3 py-2.5 rounded-xl text-[14px] text-gray-700 dark:text-gray-300 font-medium hover:bg-primary/5 hover:text-primary dark:hover:bg-primary/10 transition-colors">
