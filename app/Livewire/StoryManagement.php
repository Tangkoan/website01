...
class StoryManagement extends Component
{
    ...
    public function saveAndNextBulkItem() {
        ...
        $this->service()->saveItem([
            ...
            'thumbnail' => empty($this->bulkItem_thumbnail) ? null : (is_string($this->bulkItem_thumbnail) ? $this->bulkItem_thumbnail : $this->bulkItem_thumbnail->store('uploads/{{modelNameLower}}', 'public')),
    ...
    public function saveItem() {
        ...
        try {
            ...
            'title' => $this->title,
            'slug' => $this->slug,
            'thumbnail' => empty($this->thumbnail) ? null : (is_string($this->thumbnail) ? $this->thumbnail : $this->thumbnail->store('uploads/{{modelNameLower}}', 'public')),
